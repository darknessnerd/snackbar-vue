...
![NPM Downloads](https://img.shields.io/npm/dw/snackbar)
![Snyk Vulnerabilities for npm package](https://img.shields.io/snyk/vulnerabilities/npm/snackbar)
![NPM License](https://img.shields.io/npm/l/snackbar)
![NPM Version](https://img.shields.io/npm/v/snackbar)
![npm collaborators](https://img.shields.io/npm/collaborators/snackbar)
...
```js
import DropZone from 'snackbar';

// optionally import default styles
import 'snackbar/dist/snackbar.common.css';
